...
export const BlackGraphicLogo: React.FC<LogoProps> = ({
  ...
  return (
    <div className={`flex items-center space-x-2 sm:space-x-3.5 bg-transparent p-0 m-0 border-none shadow-none ${className}`}>
      ...
      {showText && (
        <div className="select-none min-w-0">
          <div className="flex items-center space-x-1.5 sm:space-x-2">
            <h1 className="text-base sm:text-xl md:text-2xl font-semibold font-bubble uppercase tracking-wider title-gradient whitespace-nowrap">
              BLACK GRAPHIC
            </h1>
            <span className="hidden md:inline-block px-2 py-0.5 text-[10px] font-extrabold uppercase rounded-full bg-[#FFCC00]/20 text-[#000273] dark:bg-[#FFCC00] dark:text-black border border-[#FFCC00]/50 shrink-0">
              Piura
            </span>
          </div>
          <p className="text-[10.5px] sm:text-xs text-slate-500 dark:text-slate-400 font-medium hidden sm:block truncate">
            Estudio de Impresión & Pre-prensa
          </p>
        </div>
      )}
    </div>
